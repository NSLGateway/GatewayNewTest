package com.nsl.gateway.util.testcase;
...
import com.nsl.gateway.util.XmlReader;
...
public class TestCaseItem {
	...
	public RequestData getRequestData() {
		try {
			...
			return (RequestData) new XmlReader().parseFromString(requestData, RequestData.class, "HTTP_BODY");
		} catch (Exception e) {
