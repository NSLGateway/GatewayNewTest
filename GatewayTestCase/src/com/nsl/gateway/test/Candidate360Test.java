...
public class Candidate360Test {
	...
	public void testAptitudeTestResultList() throws Exception {
		...
		XmlDiffUtils diff = new XmlDiffUtils().ignoreTag("transactionid").ignoreTag("timestamp")
				.diff(response.getContent(), FileUtils.readFileToString(testDataPath, "AptitudeTestResultList.xml"));
		assertNull(diff.getDiff());
		System.out.println("\n");
	}
